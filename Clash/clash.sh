...
echo -e "🦎” CLONANDO Configuracion del Repositorio Original GATESCCN"
fun_bar 'go get -u -v github.com/Dreamacro/clash' # 1> /dev/null 2> /dev/null
clear
echo -e "🦎” CRACKEANDO Y CONVIRTIENDO Directorios y Archivos"
...
echo -e "\033[1;37m      ã€      GATESCCN-ELMANDARINSNIFF. VPSPack      ã€‘\033[0m"
...
- name: "GATESCCN-ELMANDARINSNIFF"
  ...
  proxies:
    ...
    #- Trojan🇪🇨_Public2_v-3
    #- Trojan🇪🇨_Public3_v-4
######----- SnellPublic GATESCCN-ELMANDARINSNIFF
#######----- Socks  V2rayUC GATESCCN-ELMANDARINSNIFF
########----- ShadowsocksPublic GATESCCN-ELMANDARINSNIFF
  url: http://www.gstatic.com/generate_204
  interval: 300
 
###################################
# GATESCCN-ELMANDARINSNIFF

# By GATESCCN-ELMANDARINSNIFF
- name: "ServidoresPremiumGratis💢ProhibidaSuVenta"
  type: select
  proxies: 
    - "GATESCCN-ELMANDARINSNIFF"

- name: "Para a entrar a nuestro Team contactar +59162069439 Whatsapp"
  type: select
  proxies:
    - "GATESCCN-ELMANDARINSNIFF"
...
rules:
- DOMAIN-SUFFIX,local,GATESCCN-ELMANDARINSNIFF
- DOMAIN-SUFFIX,google.com,GATESCCN-ELMANDARINSNIFF
- DOMAIN-KEYWORD,google,GATESCCN-ELMANDARINSNIFF
- DOMAIN,google.com,GATESCCN-ELMANDARINSNIFF
- DOMAIN-SUFFIX,ad.com,GATESCCN-ELMANDARINSNIFF
- SRC-IP-CIDR,192.168.1.201/32,GATESCCN-ELMANDARINSNIFF
- IP-CIDR,127.0.0.0/8,GATESCCN-ELMANDARINSNIFF
- GEOIP,IR,GATESCCN-ELMANDARINSNIFF
- MATCH, GATESCCN-ELMANDARINSNIFF
...
fun_ip
figlet -p -f smslant < /root/name
echo -e "\033[1;37m      ã€      GATESCCN-ELMANDARINSNIFF Mods. VPSPack      ã€‘\033[0m"
echo -e "[\033[1;31m-\033[1;33m]\033[1;31m \033[1;33m"
#echo -e "\033[1;33mÎ” Escriba el puerto de Trojan Server"
#read -p ": " troport
echo -e "[\033[1;31m-\033[1;33m]\033[1;31m \033[1;33m"
