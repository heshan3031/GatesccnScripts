#!/bin/bash
#19/12/2022 renovado por el puto mandarin sniff mrd
clear
msg -bar
...
msg -bar
    echo -e " PANEL VPS-MX By @gatesccn"
...
clear
	SSR_installation_status
	echo && echo -e "    ###¿Que desea realizar?###Mod By @gatesccn
$(msg -bar)
...
echo -e "\033[1;37m       =====>>►► 🐲 PANEL BOLSCRIPTS 🐲 ◄◄<<=====       \033[1;37m"
msg -bar
