#!/bin/bash
#19/05/2022 EDITADO POR EL MANDARIN SNIFF
clear
msg -bar
...
cd socks
patch="https://github.com/Gatesccn/GatesccnScripts/blob/main/backsocz"
arq="backsocz"
...
echo -e "\033[1;32m INSTALADOR SOCKS New-Ultimate Mod-GATESCCN Mod $(cat < /etc/adm-lite/v-local.log)"
msg -bar
...
[[ "$texto_soket" = "" ]]&& texto_soket='<span style="color: #ff0000;"><strong><span style="color: #ff9900;">ECHO_POR_ELMANDARINSNIFF_</span>-<span style="color: #008000;">@GATESCCN</span>-ADM</strong></span>'
#RESPONSE '
    msg -bar
    case $portproxy in
